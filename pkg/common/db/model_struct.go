...
type ChatLog struct {
	...
	SenderFaceURL    string    `gorm:"column:sender_face_url;type:varchar(255);index:content_type,priority:1" json:"senderFaceURL"`
	SessionType      int32     `gorm:"column:session_type;index:session_type,priority:2" json:"sessionType"`
	MsgFrom          int32     `gorm:"column:msg_from" json:"msgFrom"`
	ContentType      int32     `gorm:"column:content_type;index:content_type,priority:2" json:"contentType"`
