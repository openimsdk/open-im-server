...
cd ${sdk_server_binary_root}
  nohup ./${sdk_server_name}    -sdk_ws_port ${sdk_ws_ports[0]} -openIM_api_address ${api_address} -openIM_log_level ${logLevel} -openIM_ws_address ${ws_address} >>../logs/openIM.log 2>&1 &
